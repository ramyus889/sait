export default {
  ...
  item: ({ context: e }) => ({
    class: [
      ...
      "text-surface-700 dark:text-white/80",
      { "bg-green-500/20 dark:bg-green-300/20": e.active && !e.focused },
      { "bg-green-500/30 dark:bg-green-400/30": e.active && e.focused },
      { "bg-surface-100 dark:bg-surface-700/70": !e.active && e.focused },
